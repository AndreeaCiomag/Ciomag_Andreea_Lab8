...
namespace Ciomag_Andreea_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ciomag_Andreea_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Ciomag_Andreea_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
